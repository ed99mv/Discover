...
ActiveRecord::Schema[7.0].define(version: 2023_11_19_003905) do
  ...
  create_table "companies_tours", charset: "utf8mb4", collation: "utf8mb4_0900_ai_ci", force: :cascade do |t|
    t.bigint "company_id"
    t.bigint "tour_id"
    t.datetime "created_at", null: false
    t.datetime "updated_at", null: false
    t.index ["company_id"], name: "index_companies_tours_on_company_id"
    t.index ["tour_id"], name: "index_companies_tours_on_tour_id"
  end
  ...
  create_table "galleries_tours", charset: "utf8mb4", collation: "utf8mb4_0900_ai_ci", force: :cascade do |t|
    t.bigint "tour_id"
    t.bigint "gallery_id"
    t.datetime "created_at", null: false
    t.datetime "updated_at", null: false
    t.index ["gallery_id"], name: "index_galleries_tours_on_gallery_id"
    t.index ["tour_id"], name: "index_galleries_tours_on_tour_id"
  end
  ...
  create_table "reservations_users", charset: "utf8mb4", collation: "utf8mb4_0900_ai_ci", force: :cascade do |t|
    t.bigint "user_id"
